...
const SignInPage = () => (
  <div className="grid h-[calc(100vh-200px)] w-full grid-cols-2 items-center justify-items-center gap-20">
    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div className="text-center">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Introducing ChatGPT Meal Planning Assistant - the ultimate solution to
          help you effortlessly plan and organize your meals, so you can focus
          on living a healthier, happier life!
        </p>
